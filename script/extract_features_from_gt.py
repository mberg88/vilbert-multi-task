...
class FeatureExtractor:
    ...
    def extract_features(self):
        ...
        lastCntFil = os.path.join(os.path.dirname(os.path.realpath(__file__)),
                                  'extract_features_from_gt_cnt__{}.txt'.format(
                                      os.path.basename(self.args.output_folder)))
        ...
        # matchL = ['00002825', '00002826', '00002829', '00002831', '00002835', 
        #         '00002839']
        
        # add
        # if any(img['file_name'] in matchL for img in chunk):
        #   print('match found')
        # to handle matching imgs
                
        for cnt, chunk in enumerate(self._chunks(files, self.args.batch_size)):
            if cnt >= saved_cnt:
                # update last count
                ...
                try:
                    ...
                    for idx, c in enumerate(chunk):
                        self._save_feature(c["file_name"], features[idx], 
                                           infos[idx])
